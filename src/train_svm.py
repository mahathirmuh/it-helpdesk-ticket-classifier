...
def main():  # Fungsi utama program
    df = pd.read_excel("data/cobacek.xlsx")  # source data yang akan di predict
    ...
    output_path = "results/cobacek_pred.xlsx"  # Path output utama
    fallback_path = "results/cobacek_pred_new.xlsx"  # Path cadangan jika file terkunci
